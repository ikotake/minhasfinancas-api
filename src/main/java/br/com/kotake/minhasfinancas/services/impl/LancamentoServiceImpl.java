...
import br.com.kotake.minhasfinancas.model.repository.LancamentoRepository;
...
public class LancamentoServiceImpl implements LancamentoService {
	...
	public void validar(Lancamento lancamento) {
		...
		if( lancamento.getAno() <= 1900 || lancamento.getAno() >= 9999 ) {
	...
	@Override
	public Optional<Lancamento> obterPorId(int id) {
		return repository.findById(id);
	}

	@Override
	@Transactional(readOnly = true)
	public BigDecimal obterSaldoPorUsuario(int id) {
