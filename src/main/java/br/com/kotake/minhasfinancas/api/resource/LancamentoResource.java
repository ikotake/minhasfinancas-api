package br.com.kotake.minhasfinancas.api.resource;
...
import br.com.kotake.minhasfinancas.api.dto.AtualizaStatusDTO;
import br.com.kotake.minhasfinancas.api.dto.LancamentoDTO;
...
import br.com.kotake.minhasfinancas.services.LancamentoService;
...
public class LancamentoResource {
	...
	public ResponseEntity atualizarStatus( @PathVariable("id") int id , @RequestBody AtualizaStatusDTO dto ) {
		return service.obterPorId(id).map( entity -> {
